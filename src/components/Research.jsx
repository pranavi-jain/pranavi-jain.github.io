        ...
        <ScrollReveal>
          <div className="glass-card research-card">
            ...
            <p className="research-card__description">
              ...
              ledger technology, can be made suitable for time-sensitive Internet of Vehicles (IoV)
              environments by replacing its post-quantum digital signature scheme with a lower-latency
              alternative. The work evaluates tradeoffs in post-quantum cryptography
            ...
            <p className="research-card__description">
              The signature scheme studied in this paper, later standardized as ML-DSA, was selected by NIST
              in August 2024 as one of only three post-quantum cryptography standards. An independent validation
